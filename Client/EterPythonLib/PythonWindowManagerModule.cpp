...
PyObject * wndMgrSetSwapItem(PyObject * poSelf, PyObject * poArgs)
{
	UI::CWindow * pWin;
	if (!PyTuple_GetWindow(poArgs, 0, &pWin))
		return Py_BuildException();
...
#ifdef ENABLE_WINDOW_SLIDE_EFFECT
PyObject* wndMgrEnableSlidingEffect(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->EnableSlidingEffect();
	return Py_BuildNone();
}

PyObject* wndMgrDisableSlidingEffect(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->DisableSlidingEffect();
	return Py_BuildNone();
}

PyObject* wndMgrSlideIn(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->StartSlideIn();
	return Py_BuildNone();
}

PyObject* wndMgrSlideOut(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->StartSlideOut();
	return Py_BuildNone();
}

PyObject* wndMgrStopSlidIn(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->StopSlideIn();
...
PyObject* wndMgrStopSlidOut(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->StopSlideOut();
	return Py_BuildNone();
}

PyObject* wndMgrSetSpecialWindow(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	pWindow->SetSpecialWindow();
	return Py_BuildNone();
}

PyObject* wndMgrSetStoredPosition(PyObject* poSelf, PyObject* poArgs) {
	UI::CWindow* pWindow;
	long x = 0, y = 0;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	if (!PyTuple_GetLong(poArgs, 1, &x))
		return Py_BuildException();
	if (!PyTuple_GetLong(poArgs, 2, &y))
		return Py_BuildException();

	pWindow->SetStoredPositon(x, y);
	return Py_BuildNone();
}
#endif
...
PyObject* wndImageSetCoolTimeInverse(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	((UI::CImageBox*)pWindow)->SetCoolTimeInverse(bFlag);
	return Py_BuildNone();
}

PyObject* wndImageSetCoolTimeInvert(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	((UI::CImageBox*)pWindow)->SetCoolTimeInvert(bFlag);
	return Py_BuildNone();
}

PyObject* wndImageSetRectCircle(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	if (!PyTuple_GetFloat(poArgs, 1, &fCoolTime))
		return Py_BuildException();
	((UI::CImageBox*)pWindow)->SetRectCircle(fCoolTime);
	return Py_BuildNone();
}
...
void initwndMgr()
{
	static PyMethodDef s_methods[] =
	{
		...
		//
#ifdef ENABLE_WINDOW_SLIDE_EFFECT
		{ "EnableSlidingEffect",		wndMgrEnableSlidingEffect,			METH_VARARGS },
		{ "DisableSlidingEffect",		wndMgrDisableSlidingEffect,			METH_VARARGS },
		{ "SlideIn",					wndMgrSlideIn,						METH_VARARGS },
		{ "SlideOut",					wndMgrSlideOut,						METH_VARARGS },
		{ "StopSlidIn",					wndMgrStopSlidIn,					METH_VARARGS },
		{ "StopSlidOut",				wndMgrStopSlidOut,					METH_VARARGS },
		{ "SetSpecialWindow",			wndMgrSetSpecialWindow,				METH_VARARGS },
		{ "SetStoredPosition",			wndMgrSetStoredPosition,			METH_VARARGS },
#endif
		//
		// For Debug
		...
		{"SetSwapItem", wndMgrSetSwapItem, METH_VARARGS},
#endif
		...
		{ "SetCoolTimeInverseImageBox",	wndImageSetCoolTimeInverse,			METH_VARARGS },
		{ "SetCoolTimeInvertImageBox",	wndImageSetCoolTimeInvert,			METH_VARARGS },
		{ "SetRectCircle",		wndImageSetRectCircle,				METH_VARARGS },
