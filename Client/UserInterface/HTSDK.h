...
namespace HackTrap
{
	...
	*/
	...
	extern HACKTRAP_FORCEINLINE bool Initialize(const std::string& license, HackTrap::HackTrapCallback callback = nullptr, const LicenseDistributionMethod method = LicenseDistributionMethod::MEMORY);
