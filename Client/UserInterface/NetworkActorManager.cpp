...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_dwEquipEffect = src.m_dwEquipEffect;
#endif
#ifdef ___DECORUM___
	m_dwDecorumPoint = src.m_dwDecorumPoint;
#endif
...
#ifdef GUILD_RANK_EFFECT
	kCreateData.guildRank = rkNetActorData.guildRank;
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
...
#endif
#ifdef ___DECORUM___
	kCreateData.m_dwDecorumPoint = rkNetActorData.m_dwDecorumPoint;
#endif
	kCreateData.m_stLanguage=rkNetActorData.m_stLanguage;
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
	kCreateData.m_dwEquipEffect = rkNetActorData.m_dwEquipEffect;
#endif
...
#endif
#ifdef ___DECORUM___
		pkInstFind->ChangeDecorum(c_rkNetUpdateActorData.m_dwDecorumPoint);
#endif
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
		pkInstFind->SetEquipEffect(c_rkNetUpdateActorData.m_dwEquipEffect);
#endif
		pkInstFind->SetPKMode(c_rkNetUpdateActorData.m_byPKMode);
#ifdef GUILD_RANK_EFFECT
		pkInstFind->SetRankAffect(c_rkNetUpdateActorData.guildRank);
#endif
...
#endif
#ifdef ___DECORUM___
	rkNetActorData.m_dwDecorumPoint = c_rkNetUpdateActorData.m_dwDecorumPoint;
#endif
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
	rkNetActorData.m_dwEquipEffect = c_rkNetUpdateActorData.m_dwEquipEffect;
#endif
...
#ifdef GUILD_RANK_EFFECT
	rkNetActorData.guildRank = c_rkNetUpdateActorData.guildRank;
#endif
