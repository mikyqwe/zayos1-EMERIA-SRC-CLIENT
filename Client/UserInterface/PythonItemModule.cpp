...
{
	{
		CItemData::ITEM_TYPE_ARMOR,
		{
			...
			{ CItemData::ARMOR_TALISMAN, c_Equipment_Talisman },
#endif
		}
	},
...
#endif
#if defined(ENABLE_WEAPON_COSTUME_SYSTEM)//aura missing btw
...
PyObject* itemIsUnbreakableItem( PyObject* poSelf, PyObject* poArgs )
{
	int iIndex = 0;
	...
	return Py_BuildValue("b" , CItemManager::instance().IsUnbreakableItem(iIndex));
}

PyObject* itemGetTrashBinRewardCount(PyObject* poSelf, PyObject* poArgs)
{
	int iIndex = 0;
	...
	return Py_BuildValue("i" , CItemManager::instance().GetTrashBinRewardCount(iIndex));
}
#endif
...
#ifdef __ENABLE_TRASH_BIN__
		{ "IsUnbreakableItem",				itemIsUnbreakableItem,					METH_VARARGS },
		{ "GetTrashBinRewardCount",			itemGetTrashBinRewardCount,				METH_VARARGS },
#endif
#ifdef INGAME_WIKI
...
//	PyModule_AddIntConstant(poModule, "EQUIPMENT_RING2",			c_Equipment_Ring2);
	...
	PyModule_AddIntConstant(poModule, "EQUIPMENT_TALISMAN",			c_Equipment_Talisman);
#endif
#ifdef ENABLE_NEW_TALISMAN_SLOTS_NEW
	PyModule_AddIntConstant(poModule, "EQUIPMENT_TALISMAN_2",			c_Equipment_Talisman_2);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_TALISMAN_3",			c_Equipment_Talisman_3);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_TALISMAN_4",			c_Equipment_Talisman_4);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_TALISMAN_5",			c_Equipment_Talisman_5);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_TALISMAN_6",			c_Equipment_Talisman_6);
#endif
#ifdef NEW_RING_SLOT
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RING_NEW",				c_Equipment_Ring_New);
#endif
#endif
#ifdef ENABLE_SYSTEM_RUNE
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RUNE", c_Equipment_Rune);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RUNE_RED", c_Equipment_Rune_Red);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RUNE_YELLOW", c_Equipment_Rune_Yellow);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RUNE_GREEN", c_Equipment_Rune_Green);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RUNE_BLUE", c_Equipment_Rune_Blue);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_RUNE_BLACK", c_Equipment_Rune_Black);
#endif
...
#ifdef ENABLE_SYSTEM_RUNE
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_RUNE", CItemData::ITEM_TYPE_RUNE);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_RUNE_RED", CItemData::ITEM_TYPE_RUNE_RED);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_RUNE_BLUE", CItemData::ITEM_TYPE_RUNE_BLUE);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_RUNE_GREEN", CItemData::ITEM_TYPE_RUNE_GREEN);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_RUNE_YELLOW", CItemData::ITEM_TYPE_RUNE_YELLOW);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_RUNE_BLACK", CItemData::ITEM_TYPE_RUNE_BLACK);
#endif
	...
	#ifdef ENABLE_NEW_TALISMAN_GF
	PyModule_AddIntConstant(poModule, "ARMOR_TALISMAN",					CItemData::ARMOR_TALISMAN);
	#endif
...
#ifdef ENABLE_WOLFMAN_CHARACTER
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_CLAW_REDUCTION", CItemData::APPLY_ATTBONUS_DARK);
#endif
#endif
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_EFFECT",        CItemData::COSTUME_EFFECT);
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_EFFECT",		c_Costume_Slot_Effect);
#endif
}
