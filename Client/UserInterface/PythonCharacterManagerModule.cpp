...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_STATUP",		CInstanceBase::EFFECT_SPECIAL_STATUP);
#endif // ENABLE_SPECIAL_STATS_SYSTEM
	...
	PyModule_AddIntConstant(poModule, "EFFECT_GUILD_RANK_1", CInstanceBase::EFFECT_GUILD_RANK_1);
	PyModule_AddIntConstant(poModule, "EFFECT_GUILD_RANK_2", CInstanceBase::EFFECT_GUILD_RANK_2);
	PyModule_AddIntConstant(poModule, "EFFECT_GUILD_RANK_3", CInstanceBase::EFFECT_GUILD_RANK_3);
#endif
	...
	PyModule_AddIntConstant(poModule, "EFFECT_RUNA_WHITE_EQUIP", CInstanceBase::EFFECT_RUNA_WHITE_EQUIP);
	PyModule_AddIntConstant(poModule, "EFFECT_RUNA_RED_EQUIP", CInstanceBase::EFFECT_RUNA_RED_EQUIP);
	PyModule_AddIntConstant(poModule, "EFFECT_RUNA_BLUE_EQUIP", CInstanceBase::EFFECT_RUNA_BLUE_EQUIP);
	PyModule_AddIntConstant(poModule, "EFFECT_RUNA_YELLOW_EQUIP", CInstanceBase::EFFECT_RUNA_BLACK_EQUIP);
	PyModule_AddIntConstant(poModule, "EFFECT_RUNA_BLACK_EQUIP", CInstanceBase::EFFECT_RUNA_BLACK_EQUIP);
	PyModule_AddIntConstant(poModule, "EFFECT_RUNA_GREEN_EQUIP", CInstanceBase::EFFECT_RUNA_GREEN_EQUIP);
#endif
	// �ڵ����� HP, SP
	...
	PyModule_AddIntConstant(poModule, "EFFECT_OVER_KILL_START", CInstanceBase::EFFECT_OVER_KILL_START);
	PyModule_AddIntConstant(poModule, "EFFECT_OVER_KILL_END", CInstanceBase::EFFECT_OVER_KILL_END);
#endif

#ifdef ENABLE_NEW_SELECT_INTERFACE
	PyModule_AddIntConstant(poModule, "EFFECT_SELECT_PG", CInstanceBase::EFFECT_SELECT_PG);
#endif

#ifdef ENABLE_SPECIAL_AFFECT
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_AFFECT_PLAYER_1ST", CInstanceBase::EFFECT_SPECIAL_AFFECT_PLAYER_1ST);
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_AFFECT_PLAYER_2ND", CInstanceBase::EFFECT_SPECIAL_AFFECT_PLAYER_2ND);
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_AFFECT_PLAYER_3RD", CInstanceBase::EFFECT_SPECIAL_AFFECT_PLAYER_3RD);
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_AFFECT_GUILD_1ST", CInstanceBase::EFFECT_SPECIAL_AFFECT_GUILD_1ST);
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_AFFECT_GUILD_2ND", CInstanceBase::EFFECT_SPECIAL_AFFECT_GUILD_2ND);
	PyModule_AddIntConstant(poModule, "EFFECT_SPECIAL_AFFECT_GUILD_3RD", CInstanceBase::EFFECT_SPECIAL_AFFECT_GUILD_3RD);
#endif

#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "EFFECT_EQUIPMENT", CInstanceBase::EFFECT_EQUIPMENT);
#endif
#ifdef ___DECORUM___
	PyModule_AddIntConstant(poModule, "EFFECT_DECORUM",	CInstanceBase::EFFECT_DECORUM);
#endif
