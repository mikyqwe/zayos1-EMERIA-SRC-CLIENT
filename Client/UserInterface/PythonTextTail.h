...
#ifdef ___DECORUM___
			CGraphicImageInstance*			pDecorumInstance;
#endif			
#ifdef ENABLE_MULTI_LANGUAGE_SYSTEM
			CGraphicImageInstance*			pLanguageImageInstance;
#endif
			// Todo : AI°C AuºI VID·I ¹U²Uμμ·I CN´U.
			//        μμAß A³¸?AI°¡ ¾ø¾iAu °æ¿i Æ¨±æ °¡´E¼ºAI AOA½
...
#ifdef ___DECORUM___
		void AttachDecorumLegue(DWORD dwVID, BYTE bLegue);
		void DetachDecorumLegue(DWORD dwVID);
#endif
