...
BYTE c_aSlotTypeToInvenType[SLOT_TYPE_MAX] =
{
	...
	SKILLBOOK_INVENTORY,	// SLOT_TYPE_SKILLBOOK_INVENTORY
	UPPITEM_INVENTORY,		// SLOT_TYPE_UPPITEM_INVENTORY
	GHOSTSTONE_INVENTORY,	// SLOT_TYPE_GHOSTSTONE_INVENTORY
	GENERAL_INVENTORY,		// SLOT_TYPE_GENERAL_INVENTORY
#endif
