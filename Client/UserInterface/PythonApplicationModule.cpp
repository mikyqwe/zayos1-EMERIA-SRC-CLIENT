...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "GUILD_RANK_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "GUILD_RANK_EFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_RENEWAL_PVP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RENEWAL_PVP", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_ONLINE_LIST", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_ONLINE_LIST", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__ENABLE_TRASH_BIN__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_TRASH_BIN__", 0);
#endif
...
#ifdef ENABLE_COSTUME_SWITCHBOT
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_SWITCHBOT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_SWITCHBOT", 0);
#endif
...
#ifdef ENABLE_REFINE_WINDOW_SLOT_EFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_WINDOW_SLOT_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_WINDOW_SLOT_EFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TWEENY_LIBRARY", 1);
#else
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_TALISMAN_GF", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_TALISMAN_GF", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SWAPITEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SWAPITEM_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_WINDOW_SLIDE_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WINDOW_SLIDE_EFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXPANDED_MONEY_TASKBAR", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXPANDED_MONEY_TASKBAR", 0);
#endif

#ifdef GAMEMASTER_ITEMVAULE_TOOLTIP
	PyModule_AddIntConstant(poModule, "GAMEMASTER_ITEMVAULE_TOOLTIP", 1);
#else
	PyModule_AddIntConstant(poModule, "GAMEMASTER_ITEMVAULE_TOOLTIP", 0);
#endif
...
#ifdef DRAGON_SOUL_ACTIVE_EFFECT
	PyModule_AddIntConstant(poModule, "DRAGON_SOUL_ACTIVE_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "DRAGON_SOUL_ACTIVE_EFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_STATS_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_STATS_SYSTEM", 0);
#endif

#ifdef ENABLE_SPECIAL_STORAGE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_STORAGE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_STORAGE_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_FROZEN_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FROZEN_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_6_7_BONUS_NEW_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_6_7_BONUS_NEW_SYSTEM",	0);
#endif

#ifdef ENABLE_REMEMBER_LAST_SPLIT
	PyModule_AddIntConstant(poModule, "ENABLE_REMEMBER_LAST_SPLIT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REMEMBER_LAST_SPLIT", 0);
#endif

#ifdef ENABLE_NEW_SELECT_INTERFACE
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_SELECT_INTERFACE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_SELECT_INTERFACE", 0);
#endif
...
#else
	PyModule_AddIntConstant(poModule, "TARGET_INFORMATION_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_BUY_BONUS_CHANGER_IN_SWITCH_BOT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BUY_BONUS_CHANGER_IN_SWITCH_BOT", 0);
#endif

#ifdef ENABLE_OVER_KILL
	PyModule_AddIntConstant(poModule, "ENABLE_OVER_KILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_OVER_KILL", 0);
#endif
...
#ifdef SITEYE_GIT_BUTON
	PyModule_AddIntConstant(poModule, "SITEYE_GIT_BUTON", 1);
#else
	PyModule_AddIntConstant(poModule, "SITEYE_GIT_BUTON", 0);
#endif

#ifdef ENABLE_SPECIAL_AFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_AFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPECIAL_AFFECT", 0);
#endif

#ifdef ENABLE_REAL_TIME_ENCHANT
	PyModule_AddIntConstant(poModule, "ENABLE_REAL_TIME_ENCHANT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REAL_TIME_ENCHANT", 0);
#endif

#ifdef ENABLE_CHECK_SAFEBOX_IS_OPEN
	PyModule_AddIntConstant(poModule, "ENABLE_CHECK_SAFEBOX_IS_OPEN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHECK_SAFEBOX_IS_OPEN", 0);
#endif

#ifdef WON_EXCHANGE
	PyModule_AddIntConstant(poModule, "WON_EXCHANGE", 1);
#else
	PyModule_AddIntConstant(poModule, "WON_EXCHANGE", 0);
#endif

#ifdef CHANGE_PETSYSTEM
	PyModule_AddIntConstant(poModule, "CHANGE_PETSYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "CHANGE_PETSYSTEM", 0);
#endif

#ifdef GLOW_EFFECT
	PyModule_AddIntConstant(poModule, "GLOW_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "GLOW_EFFECT", 0);
#endif
...
#ifdef EFFECT_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUME_SYSTEM", true);
#else
	PyModule_AddIntConstant(poModule, "EFFECT_COSTUME_SYSTEM", false);
#endif
...
#ifdef ___DECORUM___
	PyModule_AddIntConstant(poModule, "ENABLE_DECORUM", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DECORUM", false);
#endif
#ifdef RENDER_TARGET
...
#ifdef ENABLE_NEW_TARGET_HP
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_TARGET_HP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_TARGET_HP", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GENERAL_IN_GUILD", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GENERAL_IN_GUILD", 0);
#endif
}
