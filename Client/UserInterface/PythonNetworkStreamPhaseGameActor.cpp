...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_dwEquipEffect = 0;/*chrAddPacket.awPart[CHR_EQUIPPART_EFFECT]*/;
#endif
	kNetActorData.m_dwMountVnum=0;/*chrAddPacket.dwMountVnum*/;
#ifdef GUILD_RANK_EFFECT
	kNetActorData.guildRank = 0;
#endif
	kNetActorData.m_dwLevel = 0; // ���� ���� ǥ�� ����

	if (kNetActorData.m_bType != CActorInstance::TYPE_PC &&
		kNetActorData.m_bType != CActorInstance::TYPE_NPC && kNetActorData.m_bType != CActorInstance::TYPE_PET)
	{
		const char * c_szName;
...
bool CPythonNetworkStream::RecvCharacterAdditionalInfo()
{
	...
	if(kNetActorData.m_dwVID == chrInfoPacket.dwVID)
	{
		...
		if (kNetActorData.m_bType == CActorInstance::TYPE_NPC && kNetActorData.m_dwRace != 30000 && kNetActorData.m_dwRace != 30001 
			&& kNetActorData.m_dwRace != 30002 && kNetActorData.m_dwRace != 30003 && kNetActorData.m_dwRace != 30004 && kNetActorData.m_dwRace != 30005
			&& kNetActorData.m_dwRace != 30006 && kNetActorData.m_dwRace != 30007 && kNetActorData.m_bType != CActorInstance::TYPE_PET)
		{
...
#ifdef GUILD_RANK_EFFECT
		kNetActorData.guildRank = chrInfoPacket.guildRank;
#endif
...
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
		kNetActorData.m_dwEquipEffect = chrInfoPacket.awPart[CHR_EQUIPPART_EFFECT];
#endif
#ifdef ___DECORUM___
		kNetActorData.m_dwDecorumPoint = chrInfoPacket.dwDecorumPoint;
#endif
...
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
	kNetActorData.m_dwEquipEffect = chrAddPacket.awPart[CHR_EQUIPPART_EFFECT];
#endif
#ifdef ENABLE_NEW_ARROW_SYSTEM
...
#ifdef GUILD_RANK_EFFECT
	kNetUpdateActorData.guildRank = chrUpdatePacket.guildRank;
#endif
#ifdef ENABLE_AURA_SYSTEM
...
#endif
#ifdef ENABLE_EFFECT_COSTUME_SYSTEM
	kNetUpdateActorData.m_dwEquipEffect = chrUpdatePacket.awPart[CHR_EQUIPPART_EFFECT];
#endif
...
#endif
#ifdef ___DECORUM___
	kNetUpdateActorData.m_dwDecorumPoint = chrUpdatePacket.dwDecorumPoint;
#endif
	kNetUpdateActorData.m_dwVID=chrUpdatePacket.dwVID;
	kNetUpdateActorData.m_kAffectFlags.CopyData(0, sizeof(chrUpdatePacket.dwAffectFlag[0]), &chrUpdatePacket.dwAffectFlag[0]);
	kNetUpdateActorData.m_kAffectFlags.CopyData(32, sizeof(chrUpdatePacket.dwAffectFlag[1]), &chrUpdatePacket.dwAffectFlag[1]);
